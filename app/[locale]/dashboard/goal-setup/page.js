              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="input-premium w-full !pl-12 pr-6 py-4 text-xl font-semibold text-white rounded-2xl border border-white/10 focus:border-[#1ED760] focus:ring-2 focus:ring-green-500 transition-all [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none [appearance:textfield]" 
                    placeholder="0" 
                  />
                </div>
              </div>
